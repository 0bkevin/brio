...
func TestRoutePath(t *testing.T) {
	tests := []struct {
		...
		{path: "/api/sessions/sess_1/display-messages", kind: RouteControlForward, forwardTo: "/api/sessions/sess_1/messages"},
		...
		{path: "/api/sessions/sess_1/display-messages/extra", kind: RouteUnknown},
